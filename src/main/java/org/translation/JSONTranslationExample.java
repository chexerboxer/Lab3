...
public class JSONTranslationExample {
    ...
    public JSONTranslationExample() {
        try {
            ...
            Path jsonPath = Paths.get(getClass().getClassLoader().getResource("sample.json").toURI());
    ...
    public String getCanadaCountryNameSpanishTranslation() {
        // convention advises you don't use direct numbers in code (people don't understand what they represent)
    ...
    public String getCountryNameTranslation(String countryCode, String languageCode) {
        // sample.json stores dict objects --> get key for country code and language code and search to return
        int i;
